/* ============================================================
   ...
   ============================================================ */
const CACHE_VERSION = 'stackroom-v6'; // bumped: security hardening pass changed index.html substantially — this forces every existing install to re-fetch it instead of continuing to serve the old cached copy
