/* ============================================================
   ...
   ============================================================ */
const CACHE_VERSION = 'stackroom-v7'; // bumped: multi-copy return selection + class filter (index.html changed); previously v6: security hardening pass changed index.html substantially — this forces every existing install to re-fetch it instead of continuing to serve the old cached copy
